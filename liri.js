...
function UserInputs (input1, input2){
    ...
    case "do-what-it-says":
        ...
        break;
    default: 
        console.log("Please use one of the following inputs: \nconcert-this \nspotify-this-song \nmovie-this \ndo-what-it-says")
    }
}
    ...
    spotify.search(
        ...
        function (err, data) {
            ...
            for (var i = 0; i < songs.length; i++) {
                ...
                fs.appendFileSync("log.txt", "-- Sing Info --\n");
                console.log(i);
                fs.appendFileSync("log.txt", i +"\n");
...
function showMovieInfo(input2){
    if (input2 === undefined) {
        ...
        console.log("-----------------------");
        fs.appendFileSync("log.txt", "-----------------------\n");
        console.log("If you haven't watched 'Deadpool,' you are missing out: http://www.imdb.com/title/tt0485947/");
        fs.appendFileSync("log.txt", "If you haven't watched 'Deadpool,' then you should: http://www.imdb.com/title/tt0485947/" +"\n");
        console.log("It's on Netflix!");
        fs.appendFileSync("log.txt", "It's on Netflix!\n");
    }
    var queryUrl = "http://www.omdbapi.com/?t=" + input2 + "&y=&plot=short&apikey=c375b3c1";
    request(queryUrl, function(error, response, body) {
